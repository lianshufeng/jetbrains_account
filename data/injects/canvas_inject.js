...
var canvas_inject = function () {
    ...
    var noisify = function (canvas, context) {
        ...
        if (window.localStorage['finger_canvas_inject']) {
            shift = JSON.parse(window.localStorage['finger_canvas_inject']);
        } else {
            shift = {
                'r': Math.floor(Math.random() * 10) - 5,
                'g': Math.floor(Math.random() * 10) - 5,
            ...
            window.localStorage['finger_canvas_inject'] = JSON.stringify(shift);
        }
