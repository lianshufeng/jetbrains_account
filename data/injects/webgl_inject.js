...
var inject = function () {
    ...
    //缓存随机种子
    let config_random_value = null;
    if (window.localStorage['finger_webgl_inject']) {
        config_random_value = window.localStorage['finger_webgl_inject'];
    } else {
        config_random_value = Math.random();
        window.localStorage['finger_webgl_inject'] = config_random_value;
    }
